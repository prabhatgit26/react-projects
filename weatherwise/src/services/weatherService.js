...
const API_KEY = 'f5ad1f12a6d990093b2975d7c6a0a3d6'
...
const formatToLocalTime = (secs, offset, format = "cccc, dd LLL yyyy' |  Local time : 'hh:mm a") => DateTime.fromSeconds(secs + offset, {zone: 'utc'}).toFormat(format);
 ...
 const formatCurrent = (data) =>{
    ...
    return{
        temp, feels_like, temp_min, temp_max, humidity, name, country, sunrise: formatToLocalTime(sunrise, timezone, 'hh:mm a'), sunset: formatToLocalTime(sunrise, timezone, 'hh:mm a'), speed, details, icon: iconUrlFromCode(icon),
